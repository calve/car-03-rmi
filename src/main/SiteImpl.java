...
public class SiteImpl extends UnicastRemoteObject implements SiteItf {
	...
	public static void main(String[] args) {
		...
		/* Lire l'id du p√®re dans args */
		/* R√©cup√®re une instance du p√®re aupr√®s de RMIregistry */
		/* new SiteImpl(? id_pere) */
		/* while (true) ? */
		
		/* Recherche de l'instance auprËs du registry dans Tree.java
		 * Dans cette classe, crÈation du noeud de l'arbre.
		 * Sera utiliser dans un .sh pour crÈer des noeuds et les lier 
